...
<div class="content-right">           
		<div id="breadcrumb-panel">
			<div id="breadcrumbs">
				...
				<li><a target="_top" class="clsAltNormalOneSmaller" href=""><span itemprop="title">Home</span></a></li>
				<li><span class="clsBreadCrumbsHighlighted" itemprop="title"><?php the_title();?></span></li>
				</ol>
            </div>
        </div>
...
<div class="content-area general container">
        ...
        <h1 class="hide"><span><?php the_title();?></span></h1>
...
<div class="content-left sidebar">
        ...
        <div class="promo"><a href=""><img alt="Outlined image of map of Australia" src="images/promo-where-will-you-go3.jpg"></a> <a href=""><strong>Discover study locations across Australia</strong></a></div>
